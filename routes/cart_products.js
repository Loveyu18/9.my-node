...
const getListHandler = async (req, res) => {
        ...
        const sql01 = "SELECT COUNT(1) totalRows FROM cart_products"; // totalRows 是別名，可自定義
        ...
        if (totalRows) {
            ...
            const sql02 = `SELECT * FROM cart_products LIMIT ${(page - 1) * output.perPage}, ${output.perPage}`;
